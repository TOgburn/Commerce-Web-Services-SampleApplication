...
using IndustryType = schemas.ipcommerce.com.Ipc.General.WCF.Contracts.Common.External.SvcInfo.IndustryType;
    ...
    #region Variable Declarations
        ...
        private void cmdAuthorizeAndCapture_Click(object sender, EventArgs e)
        {
            ...
            if (_bcs != null)
            {
                ...
                try
                {
                    BankcardTransaction BCtransaction = DataGenerator.SetBankCardTxnData();
        ...
        {//The ReturnById() operation is used to return a transaction that has been previously captured.
            ...
            else if (_svas != null) //Process a Stored Value Transaction
            {
                ...
                try
                {
                    StoredValueTransaction SVtransaction = DataGenerator.SetStoredValueTxnData();
                    List<ResponseDetails> response = new List<ResponseDetails>();
        ...
        private void cmdCardTokenization_Click(object sender, EventArgs e)
        {
            ...
            if (_bcs != null) //Process a BankCard Transaction
            {
                try
                {
                    ...
                    BCtransaction = DataGenerator.SetBankCardTxnData();//Reset the back card information
            ...
            if (_bcs != null) //Process a BankCard Transaction
            {
                ...
                try
                {
                    ...
                    {//In this case the work flow is a "AuthorizeAndCapture"
                        ...
                        BCtransaction = DataGenerator.SetBankCardTxnData(BCPO);
                    ...
                    {//In this case the work flow is an "Authorize" followed by a "Capture"
                        ...
                        if (BCR.CommercialCardResponse == CommercialCardResponse.BusinessCard | BCR.CommercialCardResponse == CommercialCardResponse.CorporateCard | BCR.CommercialCardResponse == CommercialCardResponse.PurchaseCard)
                        {
                            ...
                            BCP.Level2Data = DataGenerator.SetLevel2Data();
            ...
            if (_bcs != null) //Process a BankCard Transaction
            {
                try
                {
                    ...
                    {//In this case the work flow is an "Authorize" followed by a "Capture"
                        ...
                        {
                            BankcardCapturePro BCP = new BankcardCapturePro();
                            BCP.Level2Data = DataGenerator.SetLevel2Data(); //Level 3 purchase card is always inclusive of Level 1 and Level 2 data.
                            ...
                            {
                                LIDS.Add(DataGenerator.SetLevel3Data());
                            }
            ...
            if (_bcs != null) //Process a BankCard Transaction
            {
                try
                {
                    ...
                    if (ChkMagensaAuthorizeAndCapture.Enabled && ChkMagensaAuthorizeAndCapture.Checked)
                    {
                        ...
                        List<ResponseDetails> RD = Helper.ProcessBCPTransaction(TransactionType.AuthorizeAndCapture, BCtransaction, null, null, null, null, null, null, null, ChkAcknowledge.Checked, ChkUserWorkflowId.Checked);
                    ...
                    {
                        //Temporary since Magensa does not pass back card type and masked pan
                        List<ResponseDetails> RD = Helper.ProcessBCPTransaction(TransactionType.Authorize, BCtransaction, null, null, null, null, null, null, null, ChkAcknowledge.Checked, ChkUserWorkflowId.Checked);
                        RD[0].CardType = MG.CardType;
                        RD[0].MaskedPan = MG.MaskedPAN;
                        processResponse(RD);
                    }
        ...
        private void cmdPersistConfig_Click(object sender, EventArgs e)
        {
            ...
            */
            try
            {
                ...
                DataGenerator.SavePersistedConfig(PACS);
                DataGenerator.LoadPersistedConfig();
        ...
        private void ChkTrackDataFromMSR_Click(object sender, EventArgs e)
        {
            ...
            if (DataGenerator._ITV._IndustryType == IndustryType.Ecommerce | DataGenerator._ITV._IndustryType == IndustryType.MOTO)
                MessageBox.Show("Please note that your current industry type is " + DataGenerator._ITV._IndustryType + " which typically does not support card present.");
        }
        ...
        private void CboindustryType_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (CboindustryType.Text.Length > 0)
            {
                if (CboindustryType.Text == "Ecommerce")
                    DataGenerator.getIndustryType("Ecommerce");
                if (CboindustryType.Text == "MOTO")
                    DataGenerator.getIndustryType("MOTO");
                if (CboindustryType.Text == "Retail")
                    DataGenerator.getIndustryType("Retail");
                if (CboindustryType.Text == "Restaurant")
                    DataGenerator.getIndustryType("Restaurant");
            }
        }

        private void CboCardTypes_SelectedIndexChanged(object sender, EventArgs e)
        {
            DataGenerator.SandboxTestCardData();
        }
